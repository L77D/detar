  ...
  schema() {
    ...
    return [
      ...
      { g: "Einblick (Portal)", items: [
        ...
        { o: PORTAL, k: "windowW", l: "Fenster Breite (Anteil)", min: 0.3, max: 1.3, step: 0.01, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "windowH", l: "Fenster Höhe (Anteil)", min: 0.3, max: 1.1, step: 0.01, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "windowOffsetZ", l: "Fenster-Versatz (hoch)", min: -0.35, max: 0.35, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "frameW", l: "Rahmen-Dicke", min: 0, max: 0.08, step: 0.002, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "frameRadius", l: "Rahmen-Eckradius", min: 0, max: 0.15, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "frameColor", l: "Rahmen-Farbe", color: true, on: () => window.__detar?.portal?.applyWindow() },
        ...
        { o: PORTAL, k: "peekX", l: "Figur-Position X", min: -0.5, max: 0.5, step: 0.01 },
        { o: PORTAL, k: "captionScale", l: "Caption-Textgröße", min: 0.3, max: 2, step: 0.05 },
        { o: PORTAL, k: "swayDeg", l: "Sway (±°)", min: 0, max: 6, step: 0.1 },
        { o: PORTAL, k: "swayMin", l: "Sway-Pause min (s)", min: 0.2, max: 6, step: 0.1 },
        { o: PORTAL, k: "swayMax", l: "Sway-Pause max (s)", min: 0.2, max: 8, step: 0.1 },
        { o: PORTAL, k: "dotDepth1", l: "Punkte außen: Tiefe", min: 0.05, max: 1, step: 0.01, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "dotDepth2", l: "Punkte innen: Tiefe", min: 0.05, max: 1, step: 0.01, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "dotInset1", l: "Punkte außen: Abstand", min: 0, max: 0.2, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "dotInset2", l: "Punkte innen: Abstand", min: 0, max: 0.2, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "dotSize", l: "Punkt-Größe", min: 0.004, max: 0.05, step: 0.002, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "dotGap", l: "Punkt-Abstand", min: 0.04, max: 0.4, step: 0.01, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "dotColor", l: "Punkt-Farbe", color: true, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "tabH", l: "Tabs: Höhe aktiv", min: 0.02, max: 0.15, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "tabHInactive", l: "Tabs: Höhe inaktiv", min: 0.01, max: 0.12, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "tabRaiseLerp", l: "Tabs: Fahr-Tempo", min: 0.02, max: 1, step: 0.02 },
        { o: PORTAL, k: "tabGap", l: "Tabs: Lücke", min: 0, max: 0.1, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "tabInset", l: "Tabs: Rand-Einzug", min: 0, max: 0.2, step: 0.005, on: () => window.__detar?.portal?.applyWindow() },
        { o: PORTAL, k: "peekZ", l: "Figur: Tiefe hinter Kante", min: 0, max: 0.35, step: 0.01 },
        { o: PORTAL, k: "peekTilt", l: "Figur: Drehung (°)", min: -45, max: 45, step: 1 },
        { o: PORTAL, k: "captionDX", l: "Caption: Abstand rechts", min: 0, max: 0.8, step: 0.01 },
